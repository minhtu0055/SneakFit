...
namespace SneakFit.Data.EF
{
    public class SneakFitDbContext : IdentityDbContext<AppUser>
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-KF3B918\\SQLEXPRESS;Database=SneakFit;Trusted_Connection=True;TrustServerCertificate=True;MultipleActiveResultSets=true");       
        }
